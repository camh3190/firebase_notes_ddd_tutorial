...
class _$NoteWatcherEventTearOff {
  ...
  _WatchAUncompletedStarted watchUncompletedStarted() {
    return const _WatchAUncompletedStarted();
  }
...
mixin _$NoteWatcherEvent {
  ...
  Result map<Result extends Object>({
    ...
    @required Result watchUncompletedStarted(_WatchAUncompletedStarted value),
    @required Result notesReceived(_NotesReceived value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result watchAllStarted(_WatchAllStarted value),
    Result watchUncompletedStarted(_WatchAUncompletedStarted value),
...
abstract class _$WatchAUncompletedStartedCopyWith<$Res> {
  factory _$WatchAUncompletedStartedCopyWith(_WatchAUncompletedStarted value,
          $Res Function(_WatchAUncompletedStarted) then) =
      __$WatchAUncompletedStartedCopyWithImpl<$Res>;
}

class __$WatchAUncompletedStartedCopyWithImpl<$Res>
    extends _$NoteWatcherEventCopyWithImpl<$Res>
    implements _$WatchAUncompletedStartedCopyWith<$Res> {
  __$WatchAUncompletedStartedCopyWithImpl(_WatchAUncompletedStarted _value,
      $Res Function(_WatchAUncompletedStarted) _then)
      : super(_value, (v) => _then(v as _WatchAUncompletedStarted));

  @override
  _WatchAUncompletedStarted get _value =>
      super._value as _WatchAUncompletedStarted;
}

class _$_WatchAUncompletedStarted implements _WatchAUncompletedStarted {
  const _$_WatchAUncompletedStarted();
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _WatchAUncompletedStarted);
  }
...
abstract class _WatchAUncompletedStarted implements NoteWatcherEvent {
  const factory _WatchAUncompletedStarted() = _$_WatchAUncompletedStarted;
}
