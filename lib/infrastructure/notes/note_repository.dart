...
import 'package:firebasenotesddd/infrastructure/notes/note_dtos.dart';
import 'package:flutter/services.dart';
import 'package:injectable/injectable.dart';
import 'package:firebasenotesddd/domain/notes/note_failure.dart';
import 'package:firebasenotesddd/domain/notes/note.dart';
import 'package:firebasenotesddd/infrastructure/core/firestore_helpers.dart';
    ...
    yield* userDoc.noteCollection
      ...
      if (e is PlatformException && e.message.contains('PERMISSION_DENIED')) {
        return left<NoteFailure, KtList<Note>>(
            const NoteFailure.isufficientPermission());
      } else {
  ...
  Future<Either<NoteFailure, Unit>> create(Note note) async {
    try {
      ...
      if (e.message.contains('PERMISSION_DENIED')) {
        return left(const NoteFailure.isufficientPermission());
      } else {
